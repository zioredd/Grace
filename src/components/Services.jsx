      ...
      <div className="w-[90vw] md:w-[80vw] m-auto">
        <div className="  w-full flex  py-10 gap-10 md:flex-row flex-col">
          <p>
            ...
            impedit sed nihil assumenda rem, inventore eum beatae dolores harum?
            Quos a maiores sequi nobis dolores. Minus unde facere natus
            ...
            ullam quos incidunt recusandae laboriosam a rem at assumenda placeat
            quisquam aspernatur autem totam deserunt. Quisquam enim illo
            asperiores aliquid quae? Beatae, odit molestiae quas
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi ut
            velit vitae magnam corporis fuga temporibus! Veritatis, voluptatem.
            Ad minima hic aperiam nobis! Temporibus veritatis enim pariatur
            labore rerum ullam deleniti aliquid repellendus porro illum
            asperiores, explicabo amet non consequuntur dignissimos laudantium
            esse debitis necessitatibus quidem dolorum maxime sunt, molestiae
            accusamus. Ipsa aperiam, fugiat quae illo eos, laudantium eligendi
            molestias quidem ipsam cum ducimus, eaque esse aspernatur earum
            totam! Eaque veritatis rerum dolorem laudantium, commodi esse
            molestiae recusandae odio, quidem eaque!
          </p>
